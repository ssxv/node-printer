...
export function getSupportedPrintFormats(
  cb: (err: Error | null, formats?: string[]) => void
): void;
...
export function getJob(
  printerName: string,
  jobId: number,
  cb: (err: Error | null, job?: JobDetails) => void
): void;
...
export function getSupportedJobCommands(
  cb: (err: Error | null, cmds?: string[]) => void
): void;
