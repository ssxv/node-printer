...
function loadBinding() {
  ...
  // 4. cannot load
  throw new Error(
    'Failed to load modern node_printer binding. Tried build/Release/node_printer.node, prebuild-install, and node-gyp rebuild. Ensure native build succeeded or install prebuilt binaries.'
  );
}
