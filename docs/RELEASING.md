...
If you want to delete and recreate it:
...
If the tag exists on remote too:

```
git push origin :refs/tags/v0.1.6   # delete remote tag
git push origin v0.1.6              # push new tag
```
